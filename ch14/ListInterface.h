...
public:
    ...
    */
    ...
    /**
     * @brief Gets the entry at the given position in this list.
    ...
    /**
     * @brief Replaces the entry at the given position in this list.
     * @pre 1 <= position <= getLength()
     * @post The entry at the given position is newEntry
     * @param position The list position of te entry to replace.
