...
public:
   ...
   ItemType getRootData() const override; // throw(PrecondViolatedExcep) override;
   ...
   void clear() override;
   ItemType getEntry(const ItemType& anEntry) const override; // throw(NotFoundException) override;
